...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.showMenu = function(menuType) {
        ['featuredMenu', 'mainMenu', 'drinksMenu'].forEach(id => {
            document.getElementById(id)?.classList.add('hidden');
        });

        ['featuredBtn', 'mainBtn', 'drinksBtn'].forEach(id => {
            document.getElementById(id)?.className = 'bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300 transition-colors';
        });
    ...
    class RestaurantChatbot {
        ...
        handleBotResponse(userMessage) {
            ...
            fetch('https://two000-habesha.onrender.com/chat', {
                method: 'POST',
